...
import numpy as np
import matplotlib
matplotlib.use('Agg')  # Backend non interactif, supprime le message TkAgg
...
#print("Chargement YearPredictionMSD...")
#X, y = fetch_openml("YearPredictionMSD", version=1, return_X_y=True, as_frame=False)
from sklearn.datasets import fetch_openml
X, y = fetch_openml("YearPredictionMSD", version=1, return_X_y=True, as_frame=False)

# Prendre un sous-échantillon pour test rapide
X_sub = X[:5000].astype(float)
y_sub = y[:5000].astype(float)
...
n, d = X_sub.shape
print("Sous-échantillon: n =", n, "d =", d)
